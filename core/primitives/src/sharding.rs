...
#[derive(BorshSerialize, BorshDeserialize, Clone, PartialEq, Eq, Debug, Deserialize, Serialize)]
#[borsh_init(init)]
...
#[derive(Default, BorshSerialize, BorshDeserialize, Debug, Clone, PartialEq, Eq, Deserialize, Serialize)]
